...
# bertujuan untuk menjaga keberagaman solusi. 
# Jika crossover menggabungkan sifat yang sudah ada, 
...
# =========================================================
# DECODE
# ungsi decode(schedule) adalah tahap akhir yang berfungsi untuk mengubah 
